...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            WebElement parentBox = driver.findElement(By.xpath("(//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6'])[1]"));
            List<WebElement> allBoxes = parentBox.findElements(By.xpath("(//div[@class='MuiBox-root css-0'])[1]"));
