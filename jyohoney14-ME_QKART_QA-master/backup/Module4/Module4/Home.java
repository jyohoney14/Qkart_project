...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[contains(@class,'css-yg30e6')]"),product),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text()=' No products found ']"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
           ...
           // WebElement cartParent = driver.findElement(By.xpath("//div[@class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-3 css-1q5pok1']"));
